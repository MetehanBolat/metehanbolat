...
## 💻 What I Do
- ☁️ **Azure Infrastructure**: ARM/Bicep, Terraform (AVM), Landing Zones, AKS, Well-Architected Framework
- 🛠️ **DevOps & CI/CD**: Azure DevOps Pipelines, GitHub Actions
- 🔐 **Security & Compliance**: ISO27001, SoC2 Type-I/II, PIM, RBAC, Zero-trust
- ⚡ **Automation**: PowerShell, Python, ARM APIs, Terraform, Azure-CLI, Bash
